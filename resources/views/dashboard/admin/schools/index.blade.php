                    ...
                    <table class="table">
                        ...
                        @foreach ($schools as $school)
                            <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('schools.destroy', $school->id) }}" method="POST" class="d-inline-flex">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-link text-danger">Șterge</button>
                                        </form>
                                        <a class="btn btn-link text-royal" href="{{ route('schools.show', $school->id) }}">Editează</a>
                                    </td>
                            </tr>
                        @endforeach
                        </tbody>
