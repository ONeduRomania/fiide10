...
@section('content')
    <x-navbar-component class="navbar navbar-expand-md fixed-top navbar-dark bg-transparent">
        <li class="nav-item">
            <a class="nav-link" href="#feature">Despre</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#usage">Înscrie școala</a>
        </li>
        <li class="nav-item">
    ...
    <section class="section-main d-flex align-items-center">
        <div class="container text-center">
            ...
            <a class="mt-2 btn btn-royal @auth d-none @endauth" href="{{ route('register') }}">Loghează-te acum!</a>
        </div>
    </section>
