...
Breadcrumbs::for('homework.index', function (BreadcrumbTrail $trail, App\Models\School $school, App\Models\Classroom $class) {
    $trail->parent('classes.show', $school, $class);
    $trail->push('Teme', route('homework.index', [$school->id, $class->id]));
});

Breadcrumbs::for('homework.submit_get', function (BreadcrumbTrail $trail, App\Models\School $school, App\Models\Classroom $class, App\Models\Homework $homework) {
    $trail->parent('homework.index', $school, $class);
    $trail->push('Trimite', route('homework.submit_get', [$school->id, $class->id, $homework->id]));
});

Breadcrumbs::for('homework.show', function (BreadcrumbTrail $trail, App\Models\School $school, App\Models\Classroom $class, App\Models\Homework $homework) {
    $trail->parent('homework.index', $school, $class);
    $trail->push($homework->name, route('homework.show', [$school->id, $class->id, $homework->id]));
});

Breadcrumbs::for('homework.edit', function (BreadcrumbTrail $trail, App\Models\School $school, App\Models\Classroom $class, App\Models\Homework $homework) {
    $trail->parent('homework.show', $school, $class, $homework);
    $trail->push('Editează', route('homework.edit', [$school->id, $class->id, $homework->id]));
});

Breadcrumbs::for('homework.create', function (BreadcrumbTrail $trail, App\Models\School $school, App\Models\Classroom $class) {
    $trail->parent('homework.index', $school, $class);
    $trail->push('Creează', route('homework.create', [$school->id, $class->id]));
});
